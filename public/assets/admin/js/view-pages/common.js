        ...
        if (!rulesContainer) {
            ...
            rulesContainer.innerHTML = `
                <ul class="fs-12 d-flex flex-wrap gap-1 list-unstyled row-gap-0">
                    <li class="mt-0" id="rule-length"><i class="text-danger">&#10060;</i> 8+ characters</li>
                    <li class="mt-0" id="rule-lower"><i class="text-danger">&#10060;</i> Lowercase letter</li>
                    <li class="mt-0" id="rule-upper"><i class="text-danger">&#10060;</i> Uppercase letter</li>
                    <li class="mt-0" id="rule-number"><i class="text-danger">&#10060;</i> Number</li>
                    <li class="mt-0" id="rule-symbol"><i class="text-danger">&#10060;</i> Symbol</li>
                </ul>
            `;
