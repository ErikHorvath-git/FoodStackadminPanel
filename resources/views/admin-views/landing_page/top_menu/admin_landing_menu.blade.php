<!-- Nav -->
        <ul class="nav tabs-inner nav-tabs border-0 nav--tabs nav--pills pt-3">
            <li class="nav-item tabs-slide_items">
                <a class="nav-link {{ Request::is('admin/landing-page/setup') ? 'active' : '' }}"
                href="{{ route('admin.landing_page.setup') }}">{{translate('messages.Setup')}}</a>
            </li>
            <li class="nav-item tabs-slide_items">
            ...
            <li class="nav-item tabs-slide_items">
                <a class="nav-link {{ Request::is('admin/landing-page/meta-data') ? 'active' : '' }}"
                href="{{ route('admin.landing_page.meta_data') }}">{{translate('messages.Meta_data')}}</a>
            </li>
