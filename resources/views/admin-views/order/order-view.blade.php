...
@push('script_2')
    ...
    <script>
        ...
        const customerIcon = createMarkerIcon("{{ dynamicAsset('public/assets/admin/img/customer_location.png') }}");
        const restaurantIcon = createMarkerIcon("{{ dynamicAsset('public/assets/admin/img/restaurant_map_1.png') }}");
        const deliveryBoy1Icon = createMarkerIcon("{{ dynamicAsset('public/assets/admin/img/delivery_boy_map_1.png') }}");
        const deliveryBoy2Icon = createMarkerIcon("{{ dynamicAsset('public/assets/admin/img/delivery_boy_map_2.png') }}");
