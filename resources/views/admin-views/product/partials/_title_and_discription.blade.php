               ...
               <div class="card-body">
                   <div class="lang_form" id="default-form">
                       ...
                       <div class="form-group mb-0 des_wrapper">
                           ...
                           <div class="outline-wrapper">
                                <textarea required type="text" name="description[]" maxlength="600" data-maxlength="600" id="description-default" class="form-control ckeditor min-height-154px">{{ $product?->getRawOriginal('description') ?? old('description.0') }}</textarea>
                               <div class="d-flex justify-content-end">
                                   <span class="text-body-light text-right d-block mt-1">0/600</span>
                               </div>
                           </div>
                   ...
                   @foreach ($language ?? [] as $key => $lang)
                       ...
                       <div class="d-none lang_form" id="{{ $lang }}-form">
                           ...
                           <div class="form-group mb-0">
                               ...
                               <textarea type="text" name="description[]" id="description-{{ $lang }}" maxlength="600" data-maxlength="600"
