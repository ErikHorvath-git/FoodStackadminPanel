...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="validate-form global-ajax-form" action="{{ route('admin.food.update', [$product['id']]) }}" method="post" id="" enctype="multipart/form-data">
                                            ...
                                            <button type="button"
                                                ...
                                                <div class="btn-svg-wrapper">
                                                    <img width="18" height="18" class=""
                                                         src="{{ dynamicAsset('public/assets/admin/img/svg/blink-right-small.svg') }}"
                                                         alt="">
                                                </div>
